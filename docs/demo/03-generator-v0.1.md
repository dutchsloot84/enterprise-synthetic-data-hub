...
| `src/enterprise_synthetic_data_hub/io/exporters.py` | Writes governed CSVs/NDJSON/Parquet, JSON bundles, checksums, and stats-rich `snapshot_manifest_v0_1.json`. |
...
- **Manifest Tracking** – `snapshot_manifest_v0_1.json` lists every generated file, record counts, SHA-256 checksums, and entity statistics for auditing.
